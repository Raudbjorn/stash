...
func (qb *sceneMarkerFilterHandler) criterionHandler() criterionHandler {
	...
	return compoundHandler{
		...
		intCriterionHandler(sceneMarkerFilter.Rating100, "scene_markers.rating100", nil),
		...
		boolCriterionHandler(sceneMarkerFilter.AutoGenerated, "scene_markers.auto_generated", nil),
