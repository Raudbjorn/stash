	...
	tests := []struct {
		...
		},
		{
			...
			&models.VideoFile{
				...
				Encoder:        "Lavf",
				Tags:           map[string]string{"date": "2024-05-17", "description": "Container Description"},
				MetadataProbed: true,
			},
			false,
		},
	...
	tests := []struct {
		...
		},
		{
			...
			&models.VideoFile{
				...
				Comment:        "Updated Container Comment",
				Encoder:        "Updated Encoder",
				Tags:           map[string]string{"creation_time": "2024-05-17T10:30:00Z"},
				MetadataProbed: true,
			},
			false,
		},
