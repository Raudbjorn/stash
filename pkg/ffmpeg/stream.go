...
type StreamManager struct {
	...
	// streamCounts tracks the number of active live-transcode streams per file
	// path, for the concurrent-stream limiter (see stream_limiter.go).
...
type StreamManagerConfig interface {
	...
	GetMaxConcurrentStreamsPerScene() int
}
